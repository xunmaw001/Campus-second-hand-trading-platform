<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="求购数量" prop="qiugoushuliang">
          <el-input v-model="ruleForm.qiugoushuliang" 
              placeholder="求购数量" clearable  :readonly="ro.qiugoushuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="求购数量" prop="qiugoushuliang">
              <el-input v-model="ruleForm.qiugoushuliang" 
                placeholder="求购数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="预估价格" prop="yugujiage">
          <el-input v-model="ruleForm.yugujiage" 
              placeholder="预估价格" clearable  :readonly="ro.yugujiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="预估价格" prop="yugujiage">
              <el-input v-model="ruleForm.yugujiage" 
                placeholder="预估价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qiugoushuliang = true;
          ...
          if(o=='yugujiage'){
            this.ruleForm.yugujiage = obj[o];
	    this.ro.yugujiage = true;
            continue;
          }
          if(o=='zhanghao'){
	...
	this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg,'../../../ssm9087m/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `qiugouxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qiugouxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
