<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="成色" prop="chengse">
          <el-select v-model="ruleForm.chengse" placeholder="请选择成色">
            <el-option
                v-for="(item,index) in chengseOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="二手价" prop="ershoujia">
          <el-input v-model="ruleForm.ershoujia" 
              placeholder="二手价" clearable  :readonly="ro.ershoujia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="二手价" prop="ershoujia">
              <el-input v-model="ruleForm.ershoujia" 
                placeholder="二手价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yuanjia = true;
          ...
          if(o=='ershoujia'){
            this.ruleForm.ershoujia = obj[o];
	    this.ro.ershoujia = true;
            continue;
          }
      ...
      this.$http({
		...
		if(json.maijiaxingming!=''&&json.maijiaxingming){
          ...
          this.$message.error(data.msg);
            ...
            this.chengseOptions = "全新,九成新,八成新,八成新以下".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
