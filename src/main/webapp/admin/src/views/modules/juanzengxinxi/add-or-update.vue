<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="领取日期" prop="lingquriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.lingquriqi" 
                type="date"
                placeholder="领取日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.lingquriqi" label="领取日期" prop="lingquriqi">
              <el-input v-model="ruleForm.lingquriqi" 
                placeholder="领取日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.maijiaxingming = true;
          ...
          if(o=='lingquriqi'){
            this.ruleForm.lingquriqi = obj[o];
	    this.ro.lingquriqi = true;
            continue;
          }
          if(o=='zhanghao'){
