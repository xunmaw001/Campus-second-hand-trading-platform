  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:rgba(36, 194, 205, 1);fontSize:28px;">校园二手交易平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="卖家账号" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.maijiazhanghao" autocomplete="off" placeholder="卖家账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='maijia'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20201124/b960a45e1acf4bc2b364a1664aad3fdb.jpg");
		height: 100vh;
