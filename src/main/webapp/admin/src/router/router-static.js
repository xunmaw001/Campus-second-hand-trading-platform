...
import center from '@/views/center'
    ...
    import discussshangpinjuanzeng from '@/views/modules/discussshangpinjuanzeng/list'
    ...
    import shangpinjuanzeng from '@/views/modules/shangpinjuanzeng/list'
...
const routes = [{
	...
	path: '/fenlei',
      ...
      ,{
	path: '/discussshangpinjuanzeng',
        name: '商品捐赠评论',
        component: discussshangpinjuanzeng
      }
      ,{
	path: '/maijia',
        name: '卖家',
	...
	path: '/juanzengxinxi',
      ...
      ,{
	path: '/shangpinjuanzeng',
        name: '商品捐赠',
        component: shangpinjuanzeng
      }
      ,{
	path: '/config',
        name: '轮播图管理',
